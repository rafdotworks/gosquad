...
export function BriefActionBar() {
  ...
  return (
    <div
      className={cn(
        "fixed inset-x-0 bottom-0 z-30 border-t border-border bg-background px-7 py-3 shadow-[0_-8px_24px_rgba(22,21,15,0.06)] transition-transform duration-300 ease-out",
